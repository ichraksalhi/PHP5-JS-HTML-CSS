...
if (isset($_GET['id'])){
$listeproduit=$controlproduit->recupererproduit($_GET['id']);
                ...
                <div class="row">
                    ...
                    <div class="col-12 col-lg-6">
                        <div class="about--content mb-100">
                            ...
                            <!-- Key Notes -->
                            <ul class="key-notes">
                                <li><div class="check"><img src="img/core-img/check.png" alt=""></div>PRIX : <?PHP echo $prix; ?></li>
                                <li><div class="check"><img src="img/core-img/check.png" alt=""></div>MARQUE : <?PHP echo $marque; ?></li>
                                <li><div class="check"><img src="img/core-img/check.png" alt=""></div>CATEGORIE: <?PHP echo  $controlcate->affichername($cat); ?> </li>
								<li><div class="check"><img src="img/core-img/check.png" alt=""></div>DISPONIBILITE : <?PHP if($qtn > 1) {
									echo "EN STOCK";
								}else if ($qtn == 1)
								{
								echo "RESTE SEULLEMENT UN SEUL PRODUIT";
								...
								<?php
								 if($qtn > 0 ){
									echo '<input type="submit" class="btn musica-btn btn-2 m-2"  name="ajouter" value="AjouterPanier">';
								 }
									?>
