...
//$controlreclamationproduit =new ReclamationproduitC();

//$listereclamationproduit=$controlreclamationproduit->afficherReclamationproduit();
...
<body>
            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li class="menu-item-has-children dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="menu-icon fa fa-laptop"></i>reclamation</a>
                        <ul class="sub-menu children dropdown-menu">
                           
                            <li><i class="fa fa-id-badge"></i><a href="table.php">consulter reclamation</a></li>
                                ...
                                <table id="bootstrap-data-table-export" class="table table-striped table-bordered">
                                 ...
                                 foreach($listeReclamationproduits as $row){
                                    ...
                                    <tr class="row100 body"  style="background: <?php echo $color?>">
                                        <td scope="col"><?PHP echo $row['typeP']; ?></td>
                                        <td scope="col"><?PHP echo $row['categorieP']; ?></td>
                                        <td scope="col"><?PHP echo $row['numeroP']; ?></td>
                                        <td scope="col"><?PHP echo $row['descriptionP']; ?></td>
                                        <td scope="col"><?PHP echo $row['numerofacture']; ?></td>
                                        <td scope="col"><?PHP echo $row['etat']; ?></td>
                                        <td><a href="traiterReclamation.php?id=<?PHP echo $row['id']; ?>">
	Traiter</a></td>


                                        <td><form method="POST" action="sms/send-sms.php">


	<input type="submit" name="sms" class="btn btn-danger"  value=" envoyer un sms">
	<input type="hidden" value=" <?PHP echo $row['id']; ?>" name="id">
	 ...
	 <!-- <td><form method="POST" action="/sms/send-sms.php">
	<input type="submit" name="sms" class="btn btn-danger"  value="sms">
	<input type="hidden" value=" <?PHP echo $row['id']; ?>" name="id">
	</form>
    </td> -->
                                 
	<!-- <td><form method="POST" action="imprimer2.php">
	<input type="submit" name="Imprimer" class="btn btn-primary" value="Imprimer">
	<input type="hidden" value="<?PHP echo $row['id']; ?>" name="id">
	</form></td>
	</tr> -->
	<?PHP
